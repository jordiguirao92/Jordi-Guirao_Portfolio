    ...
    return(
        <>
           ...
           <Flex width='100%' justify='center' direction='column'>
            ...
            <FlexAboutCard backColor={props => props.theme.colors.grey}>
                    ...
                    <Flex direction='column' align='flex-start' margin='10px 20px'>
                        ...
                        <H3 color={props => props.theme.colors.black} weight='bold'>Front End Developer & Blockchain&DLTs Engineer</H3>
            ...
            <Flex direction='column' width='80%' align='flex-start'>
                <Flex width='100%' margin='0px'>
                    ...
                    <FontAwesomeIcon icon={faCaretSquareDown} style={{color: experiences ? '#28f6c2' : '#fc87da'}} size="2x" rotation={experiences ? 180 : 360} onClick={() => {setexperiences(!experiences)}}/>
                </Flex>
                <Flex backImage={props => props.theme.gradientPinkBlue} width='100%' height='5px'/>
                <Spacer/>
            </Flex>
            {experience.map((experience) => {
                if(experiences){
                    ...
                    return(
                        <FlexAboutCard direction='column' backColor={props => props.theme.colors.grey} margin='5px'>
                        ...
                        return(
                        <FlexAboutCard direction='column' backColor={props => props.theme.colors.grey} margin='5px'>
                                <H4 margin='0px 10px' weight='bold' color={props => props.theme.colors.black}>{experience.rol}</H4>
            ...
            <Flex direction='column' width='80%' align='flex-start'>
                <Flex width='100%' margin='0px'>
                    ...
                    <FontAwesomeIcon icon={faCaretSquareDown} style={{color: organisation ? '#28f6c2' : '#fc87da'}} size="2x" rotation={organisation ? 180 : 360} onClick={() => {setOrganisations(!organisation)}}/>
                </Flex>
                <Flex backImage={props => props.theme.gradientPinkBlue} width='100%' height='5px'/>
                <Spacer/>
            </Flex>
            {organisations.map((experience) => {
                if(organisation){
                    ...
                    return(
                        <FlexAboutCard direction='column' backColor={props => props.theme.colors.grey} margin='5px'>
                            <Flex margin='0px 10px'>
                                <H4 margin='5px 0px' weight='bold' color={props => props.theme.colors.black}>{experience.rol}</H4>
                                <P fontstyle='oblique'>{experience.startYear}-{experience.finishYear}</P>
                            </Flex>
                            <Flex margin='0px 10px'>
                                <H4 margin='0px' weight='bold'>{experience.company}</H4>
            ...
            <Flex direction='column' width='80%' align='flex-start'>
                <Flex width='100%' margin='0px'>
                    ...
                    <FontAwesomeIcon icon={faCaretSquareDown} style={{color: educations ? '#28f6c2' : '#fc87da'}} size="2x" rotation={educations ? 180 : 360} onClick={() => {setEducations(!educations)}}/>
                </Flex>
                <Flex backImage={props => props.theme.gradientPinkBlue} width='100%' height='5px'/>
                <Spacer/>
            </Flex>
            {education.map((study) => {
                if(educations){
                    ...
                    return(
                        <FlexAboutCard direction='column' backColor={props => props.theme.colors.grey} margin='5px'>
                            <Flex margin='0px 10px'>
                                <H4 margin='5px 0px' weight='bold' color={props => props.theme.colors.black}>{study.rol}</H4>
                    ...
                    return(
                        <FlexAboutCard direction='column' backColor={props => props.theme.colors.grey} margin='5px'>
                                <H4 margin='0px 10px' weight='bold' color={props => props.theme.colors.black}>{study.rol}</H4>
            ...
            <Flex direction='column' width='80%' align='flex-start'>
                <Flex width='100%' margin='0px'>
                    ...
                    <FontAwesomeIcon icon={faCaretSquareDown} style={{color: certification ? '#28f6c2' : '#fc87da'}} size="2x" rotation={certification ? 180 : 360} onClick={() => {setCertification(!certification)}}/>
                </Flex>
                <Flex backImage={props => props.theme.gradientPinkBlue} width='100%' height='5px'/>
                <Spacer/>
            </Flex>
                {certifications.map((certificate) => {
                    if(certification){
                        ...
                        return(
                            <FlexAboutCard direction='column' backColor={props => props.theme.colors.grey} margin='5px'>
                                <Flex margin='0px 10px'>
                                    <H4 margin='5px 0px' weight='bold' color={props => props.theme.colors.black}>{certificate.rol}</H4>
                            ...
                            return(
                                <FlexAboutCard direction='column' backColor={props => props.theme.colors.grey} margin='5px'>
                                        <H4 margin='0px 10px' weight='bold' color={props => props.theme.colors.black}>{certificate.rol}</H4>
